...
class SCCMClient {
    ...
    # Constructor voor andere sitecode & managementpoint indien nodig
...
$Client = [SCCMClient]::new()

$Client.GetSCCMClientfailedUpdates()
$Client.ClearSCCMClientCache()
$Client.PurgeSCCMClientWindowsUpdate()
$Client.RepairSCCMClient()
